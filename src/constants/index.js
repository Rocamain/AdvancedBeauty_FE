export const LOGO_QUERY = ['photo.media'];
...
export const COMPONENT_SIZES = (componentType) =>
  ({
    gridA:
...
export const COMPONENT_SCR_SET = (componentType) =>
  ({
...
export const COUNTY_CODE = (county) =>
  ({
